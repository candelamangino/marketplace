...
export const servicesMock = [
  {
    ...
    solicitanteId: '1',
    insumosRequeridos: [
      { insumoId: '1', cantidad: 500 }, // Cable
      { insumoId: '2', cantidad: 1 },    // Tablero
      { insumoId: '3', cantidad: 20 }   // Tomas
    ],
    cotizacionesIds: ['1', '2'],
  ...
  },
  {
    ...
    solicitanteId: '1',
    insumosRequeridos: [
      { insumoId: '4', cantidad: 50 },   // Láminas de zinc
      { insumoId: '5', cantidad: 2 }    // Pintura impermeabilizante
    ],
    cotizacionesIds: ['3'],
    cotizacionSeleccionadaId: null
  },
  {
    ...
    solicitanteId: '4',
    insumosRequeridos: [
      { insumoId: '6', cantidad: 30 },   // Latas de pintura
      { insumoId: '7', cantidad: 5 }      // Rodillos
    ],
    cotizacionesIds: ['4', '5'],
  ...
  },
  {
    ...
    solicitanteId: '4',
    insumosRequeridos: [
      { insumoId: '8', cantidad: 2 },    // Unidades de AC
      { insumoId: '1', cantidad: 100 }   // Cable
    ],
    cotizacionesIds: [],
    cotizacionSeleccionadaId: null
  }
